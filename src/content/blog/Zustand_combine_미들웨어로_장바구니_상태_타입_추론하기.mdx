---
title: 'Zustand combine 미들웨어로 장바구니 상태 타입 추론하기'
description: '프론트엔드 코드리뷰스터디 - 귤 스터디'
pubDate: 'Apr 14 2025'
heroImage: '/public/img/Screenshot%202025-04-14%20at%201.19.16%20AM.png'
---
...
![소스코드](/public/img/Screenshot%202025-04-14%20at%201.19.16%20AM.png)
...
![코드리뷰](/public/img/Screenshot%202025-04-14%20at%2012.03.39%20AM.png)
## 리팩토링
...
Zustand의 `combine` 미들웨어를 활용하면, 하나하나 타입을 선언하지 않고도 타입 안정성을 유지할 수 있다. 
